...
class HelSyncGUI(QWidget):
	...
	def show_about(self):
		...
		<div style='text-align: center;'>
			<h1 style='color: #007bff;'>Hel-Sync</h1>
			<p><b>Version:</b> 1.1 (Stable)</p>
			<hr>
			<h3 style='color: #28a745;'>💎 Technical Features:</h3>
			<ul style='text-align: left; display: inline-block; line-height: 1.5;'>
				<li>✅ Instant sync without app installation (Web-Based).</li>
				<li>✅ Full Remote Control (Mouse & Media).</li>
				<li>✅ Security system based on a unique session Token.</li>
				<li>✅ Full support for <b>Arch Linux</b> and Windows.</li>
				<li>✅ High-speed bulk file transfer (Local Network).</li>
				<li>✅ "Find My Mobile" feature.</li>
			</ul>
			<hr>
			<p style='font-weight: bold;'>Developed by: Saeed Badelden</p>
			<p style='color: #555;'>Helwan Linux Distro Community</p>
			<p style='font-family: monospace;'>helwanlinux@gmail.com</p>
		</div>
		"""
		msg = QMessageBox(self)
