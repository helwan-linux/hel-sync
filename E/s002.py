...
def index():
    ...
    return render_template_string('''
        ...
        <head>
            ...
            <style>
                body { background: #0c0c0c; color: #eee; font-family: sans-serif; text-align: center; padding: 15px; transition: background 0.3s; }
        ...
        <body>
            ...
            <div class="card">
                ...
                <div id="download_list">
                    <p style="color:#666; font-size:12px;">Checking for files...</p>
                </div>
            </div>
            <div class="card">
                <h4>Text Clipboard</h4>
                <div id="pc_clip" style="background:#000; padding:10px; border:1px dashed #555; color:#0f0; margin-bottom:10px; font-size:13px;">Waiting...</div>
            ...
            <script>
                ...
                function upload() {
                    ...
                    xhr.onload = () => {
                        ...
                        // بدلاً من Refresh، نقوم بتحديث القائمة فقط
                        refreshFileList();
                    };
                    xhr.send(formData);
                }
                ...
                function sendTxt() {
                    ...
                    fetch(`/send_from_mobile?token=${TOKEN}`, {
                        ...
                        document.getElementById('mob_txt').value='';
                        alert('Sent to PC!');
                    });
                }

                // التحديث التلقائي للحالة (بدون ريفريش)
                setInterval(() => {
                    ...
                    refreshFileList(); // تحديث قائمة الملفات كل 3 ثواني مثلاً
                }, 3000);
